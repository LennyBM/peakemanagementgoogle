...
const CookiePolicy = () => {
    ...
    return (
        <LegalLayout
            ...
            description="Cookie Policy for Peake Management. What cookies we use and why."
        >
            <p>
                This is the Cookie Policy for Peake Management, accessible from <a href="https://www.peakemanagement.com">www.peakemanagement.com</a>.
            </p>
            ...
            <ul>
                ...
                <li>
                    ...
                    <ul className="pl-6 mt-2 list-item list-disc">
            ...
            <p>
                However, if you are still looking for more information, you can contact us: <a href="mailto:leonard@peakemanagement.com">leonard@peakemanagement.com</a>.
            </p>
